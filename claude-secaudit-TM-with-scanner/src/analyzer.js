...
/** Dedup/merge logic lives in findings.js (shared with the scanner path). */
...
export async function analyze({
  ...
  return {
    findings: merged,           // NOT finalized — index.js merges with scanner findings then assigns IDs
    summaries,
    stats: {
